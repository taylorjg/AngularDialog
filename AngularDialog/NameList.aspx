...
<html id="ng-app" data-ng-app="<%= (IsInAngularJsEndToEndTestMode) ? "NameListAppE2E" : "NameListApp" %>">
    ...
    <head>
        ...
        <script src="Scripts/ThirdParty/AngularJS/1.3.0/angular.js" type="text/javascript"></script>
        <script src="Scripts/ThirdParty/AngularJS/1.3.0/angular-resource.js" type="text/javascript"></script>
        ...
        <% if (IsInAngularJsEndToEndTestMode) { %>
            ...
            <script src="Scripts/ThirdParty/AngularJS/1.3.0/angular-mocks.js" type="text/javascript"></script>
        <% } %>
    </head>
            ...
            <div class="row">
                ...
                <div class="span10">
                    <table class="table table-striped table-condensed table-bordered">
                        ...
                        <tbody>
                            <tr data-ng-repeat="item in nameListModel.items" data-ng-cloak="">
                                <td>{{item.Id}}</td>
